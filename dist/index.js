...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _lib_Resource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lib/Resource */ \"./src/lib/Resource.js\");\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n    install: function install(Vue, config) {\n        if (config.hasOwnProperty('interceptor')) {\n            var interceptor = config.interceptor;\n            if (interceptor.hasOwnProperty('request')) {\n                var request = interceptor.request;\n                config.handler.interceptors.request.use(request.success, request.error);\n            }\n            if (interceptor.hasOwnProperty('response')) {\n                var response = interceptor.response;\n                config.handler.interceptors.response.use(response.success, response.error);\n            }\n        }\n\n        _lib_Resource__WEBPACK_IMPORTED_MODULE_0__[\"default\"].prototype.baseOption = config.baseOption || {};\n\n        _lib_Resource__WEBPACK_IMPORTED_MODULE_0__[\"default\"].prototype.baseUrl = config.baseUrl || '';\n\n        _lib_Resource__WEBPACK_IMPORTED_MODULE_0__[\"default\"].prototype.handle = config.handler || function () {\n            console.log(\"请将axios作为handler\");\n        };\n        Vue.Resource = _lib_Resource__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n    }\n});\n\n//# sourceURL=webpack:///./src/index.js?");
